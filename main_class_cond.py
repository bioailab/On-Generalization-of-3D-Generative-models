...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='kl_d512_m512_l64_d24_edm', type=str, metavar='MODEL',
                        help='Name of model to train')

    parser.add_argument('--ae', default='kl_d512_m512_l64', type=str, metavar='MODEL',
