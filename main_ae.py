...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='kl_d512_m512_l64', type=str, metavar='MODEL',
    ...
    parser.add_argument('--output_dir', default='./output2/',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./output2/',
...
def main(args):
    ...
    # print("Number of tasks (world size):", num_tasks)
    # print("Global rank:", global_rank)
    # print("Sampler indices count:", len(list(iter(sampler_train))))
    ...
    # print('+'*100)
    # # Example check if using a SubsetRandomSampler or similar
    # # print(len(sampler_train.indices))
